      ...
      <div>
        {
          this.state.user === null ?
            ...
            <div >
              ...
              <div className="text-center p-4" style={{fontSize:"60px", color:"black",fontWeight:"bolder", fontFamily:"'Courier New', monospace", textShadow: "1px 1px 1px white"}}>Welcome To Royal Bus Bookings {localStorage.getItem("name")}</div>
